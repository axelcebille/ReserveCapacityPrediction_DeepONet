...
var = "residual_capacity" #"residual_capacity", "local_slenderness_ratio"
...
plt.savefig(f"ReserveCapacityPrediction_DeepONet/figures/tsne_analysis/resisting_moment/RM_tsne_latent_space_{network_type}_{var}.png", dpi=300, bbox_inches="tight")
plt.close()
