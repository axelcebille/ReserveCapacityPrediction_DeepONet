...
plt.savefig(f"ReserveCapacityPrediction_DeepONet/figures/pca_analysis/resisting_moment/RM_pca_latent_space_{network_type}_{corr_type}.png", dpi=300, bbox_inches="tight")
plt.close()
...
plt.savefig(f"ReserveCapacityPrediction_DeepONet/figures/pca_analysis/resisting_moment/RM_pca_correlation_{network_type}_{corr_type}.png", dpi=300, bbox_inches="tight")
plt.close()
