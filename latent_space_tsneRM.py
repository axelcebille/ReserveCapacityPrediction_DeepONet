...
file_path = "ReserveCapacityPrediction_DeepONet/figures/tsne_analysis/resisting_moment(translation+moment_norm)"
...
def tsne_analysisRM(data, model, device, var, network_type, file_path):
    ...
    plt.savefig(f"{file_path}/RM_tsne_latent_space_{network_type}_{var}.png", dpi=300, bbox_inches="tight")
    plt.close()
...
for var in variables:
    for network_type in network_types:
        tsne_analysisRM(data, model, device, var, network_type, file_path)
