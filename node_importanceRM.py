...
print(f"Performing node importance analysis for RM model.")
...
for col_type in data.features.keys():
    ...
    if col_type in importance_by_col:
        ...
        make_importance_gif_dynamic_graph(data, importance_list, col_type,
                                            gif_path=f"ReserveCapacityPrediction_DeepONet/figures/gifs_gradient_importanceRM/RMgradient_importance_col{col_type}.gif",
                                            elev=30, azim=60)
